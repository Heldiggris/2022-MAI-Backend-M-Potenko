# Generated by Django 4.0 on 2022-03-27 16:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('atmosphere', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='spaceapp.atmosphere')),
                ('author', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='spaceapp.user')),
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='spaceapp.category')),
                ('starSystem', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='spaceapp.starsystem')),
            ],
        ),
    ]
